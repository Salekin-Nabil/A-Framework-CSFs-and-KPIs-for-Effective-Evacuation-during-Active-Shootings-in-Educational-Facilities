...
### 1. `Code for Statistical_Analysis.ipynb`
...
- Construct validation outputs
- Statistical summaries and supporting tables

---

### 3. `Survey Metadata.xlsx`
Metadata and variable information related to the survey dataset used in this research.
...
This repository is provided as supplementary research material for academic review, transparency, and future reference. The uploaded materials support the findings presented in the associated research manuscript.
